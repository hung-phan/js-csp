...
export const goAsync = (f: Generator<any, any, any>): Function =>
  (done: Function): void => {
    goroutine(f, [done]);
  };

export const go = (f: Generator<any, any, any>) =>
  (done: Function) => {
    goroutine(function*() {
      try {
...
export const it = (desc: string, f: Generator<any, any, any>): void =>
  mocha.it(desc, go(f));

export const beforeEach = (f: Generator<any, any, any>): void =>
  mocha.beforeEach(go(f));

export const afterEach = (f: Generator<any, any, any>): void =>
  mocha.afterEach(go(f));

export const before = (f: Generator<any, any, any>): void =>
  mocha.before(go(f));
